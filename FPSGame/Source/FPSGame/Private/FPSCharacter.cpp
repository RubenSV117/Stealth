...
void AFPSCharacter::Fire()
{
	...
	if (ProjectileClass)
	{
		...
		UGameplayStatics::SpawnEmitterAtLocation(this, MuzzleFlash, MuzzleLocation);
	}
	...
	if (FireCounter < 3)
		GetWorld()->GetTimerManager().SetTimer(FireDelayTimerHandle, this, &AFPSCharacter::Fire, .07f, true);
